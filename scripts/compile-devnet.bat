...
devenv /rebuild debug %fldr%\VTAPI_VB\VTAPI_VB.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort
...
devenv /rebuild debug %fldr%\cs\libqkbm\libqkbm.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild debug %fldr%\cs\libqconsh\libqconsh.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild debug_qdbm %fldr%\lite\lite.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild debug_qdbm %fldr%\VisualText\VisualText.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort
