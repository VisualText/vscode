...
devenv /rebuild release %fldr%\VTAPI_VB\VTAPI_VB.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort



rem building the qdbm variant here as well.

devenv /rebuild release %fldr%\cs\libqkbm\libqkbm.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild release %fldr%\cs\libqconsh\libqconsh.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild release_qdbm %fldr%\lite\lite.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild release_qdbm %fldr%\VisualText\VisualText.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort
