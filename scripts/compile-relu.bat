...
devenv /rebuild "unicode release" %fldr%\cs\libprim\libprim.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild "unicode_release" %fldr%\cs\libkbm\libkbm.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild "unicode_release" %fldr%\cs\libconsh\libconsh.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild "unicode_release" %fldr%\src\web\web.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild "unicode_release" %fldr%\src\words\words.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild "unicode_release" %fldr%\lite\lite.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

devenv /rebuild "unicode_release" %fldr%\VisualText\VisualText.sln
if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

rem devenv /rebuild release_mono %fldr%\VisualTextM\VisualText.sln
rem if errorlevel 4 goto lowmemory
rem if errorlevel 2 goto abort

rem devenv /rebuild release_mono_noweb %fldr%\VisualTextM\VisualText.sln
rem if errorlevel 4 goto lowmemory
rem if errorlevel 2 goto abort

rem Need unicode release for VTAPI_VB
