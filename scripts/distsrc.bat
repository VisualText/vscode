...
xcopy %fm_dir%\cs\libqkbm\*.sln  %to_dir%\cs\libqkbm\ /e /h /i
xcopy %fm_dir%\cs\libqkbm\*.vcproj  %to_dir%\cs\libqkbm\ /e /h /i
xcopy %fm_dir%\cs\libqkbm\*.dsw  %to_dir%\cs\libqkbm\ /e /h /i
xcopy %fm_dir%\cs\libqkbm\*.dsp  %to_dir%\cs\libqkbm\ /e /h /i
xcopy %fm_dir%\cs\libqkbm\*.cpp  %to_dir%\cs\libqkbm\ /e /h /i
xcopy %fm_dir%\cs\libqkbm\*.h  %to_dir%\cs\libqkbm\ /e /h /i
...
xcopy %fm_dir%\cs\libqconsh\*.sln  %to_dir%\cs\libqconsh\ /e /h /i
xcopy %fm_dir%\cs\libqconsh\*.vcproj  %to_dir%\cs\libqconsh\ /e /h /i
xcopy %fm_dir%\cs\libqconsh\*.dsw  %to_dir%\cs\libqconsh\ /e /h /i
xcopy %fm_dir%\cs\libqconsh\*.dsp  %to_dir%\cs\libqconsh\ /e /h /i
xcopy %fm_dir%\cs\libqconsh\*.cpp  %to_dir%\cs\libqconsh\ /e /h /i
xcopy %fm_dir%\cs\libqconsh\*.h  %to_dir%\cs\libqconsh\ /e /h /i
...
xcopy %fm_dir%\qdbm %to_dir%\qdbm /e /h /i
...
rmdir /s /q %to_dir%\cs\libqconsh\Debug
rmdir /s /q %to_dir%\cs\libqconsh\Release
rmdir /s /q %to_dir%\cs\libqconsh\Unicode_Debug
rmdir /s /q %to_dir%\cs\libqconsh\Unicode_Release
...
rmdir /s /q %to_dir%\cs\libqkbm\Debug
rmdir /s /q %to_dir%\cs\libqkbm\Release
rmdir /s /q %to_dir%\cs\libqkbm\Unicode_Debug
rmdir /s /q %to_dir%\cs\libqkbm\Unicode_Release
