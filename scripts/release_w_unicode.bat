...
xcopy %fm_dir%\bin\web.dll %to_dir%anadll\ /e /h /i

if errorlevel 4 goto lowmemory
if errorlevel 2 goto abort

xcopy %fm_dir%\bin\webu.dll %to_dir%anadll\ /e /h /i
...
rem qdbm variants 03-13-07 AM.
xcopy %fm_dir%\bin\libqkbm.dll   %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\libqconsh.dll %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\liteq.dll     %to_dir%anadll\ /e /h /i

xcopy %fm_dir%\bin\wordsu.dll    %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\liteu.dll     %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\libprimu.dll  %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\libkbmu.dll   %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\libconshu.dll %to_dir%anadll\ /e /h /i

xcopy %fm_dir%\bin\qdbm.dll %to_dir%anadll\ /e /h /i

xcopy %fm_dir%\bin\libstreamu.dll %to_dir%anadll\ /e /h /i
...
xcopy %fm_dir%\bin\VTAPI_VB.dll %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\VTAPI_VB.def %to_dir%anadll\ /e /h /i

xcopy %fm_dir%\dll\ics.dll %to_dir%anadll\ /e /h /i

xcopy %fm_dir%\icu\bin\*.dll  %to_dir%anadll\ /e /h /i
...
xcopy "c:\program files\codejock software\mfc\toolkit\bin_vc71\XT4100Libu.dll"  %to_dir%vtdll\ /e /h /i
...
rem xcopy C:\WINDOWS\SYSTEM32\MSVCRTD.DLL %to_dir%anadll\ /h
...
xcopy %fm_dir%\lib\liteq.exp     %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libqkbm.exp   %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libqconsh.exp %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\liteq.lib     %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libqkbm.lib   %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libqconsh.lib %to_dir%lib\ /e /h /i

xcopy %fm_dir%\lib\liteu.exp     %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libprimu.exp  %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libkbmu.exp   %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libconshu.exp %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\webu.exp      %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\wordsu.exp    %to_dir%lib\ /e /h /i

xcopy %fm_dir%\lib\liteu.lib     %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libprimu.lib  %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libkbmu.lib   %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libconshu.lib %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\webu.lib      %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\wordsu.lib    %to_dir%lib\ /e /h /i

xcopy %fm_dir%\lib\libstreamu.exp     %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\libstreamu.lib     %to_dir%lib\ /e /h /i

xcopy %fm_dir%\lib\vtapi_vb.exp     %to_dir%lib\ /e /h /i
xcopy %fm_dir%\lib\vtapi_vb.lib     %to_dir%lib\ /e /h /i
...
xcopy %fm_dir%\icu\include\unicode %to_dir%include\unicode /e /h /i
...
copy /y %fm_dir%\VisualText\unicode_release\VisualText.exe  %to_dir%exe\VisualTextU.exe

copy /y %fm_dir%\VisualText\release_qdbm\VisualTextQ.exe  %to_dir%exe\VisualTextQ.exe

rem Get the tip of the day file.  05/18/08 AM.
rem For now, one file serves all versions.  In time, each variant
rem can get its own tips file.
copy /y %fm_dir%\VisualText\debug\tips.txt  %to_dir%exe\tips.txt
...
mkdir %to_dir%exeT
xcopy %fm_dir%\VisualTextM\VisualText___Win32_Release_Mono\VisualText.exe %to_dir%exeT\ /e /h /i

mkdir %to_dir%exeTX
xcopy %fm_dir%\VisualTextM\VisualText___Win32_Release_Mono_Noweb\VisualText.exe %to_dir%exeTX\ /e /h /i
...
rem this seems to delete resx also 4-23-09 AM
rem del /f /s /q %to_dir%*.res
del /f /s /q %to_dir%*.rc
